let playerFinalXS4 = 0;
let playerFinalYS4 = 0;
...
class Stage4 extends Phaser.Scene{
	...
	create(){
		...
		if(this.player1.x < 200){
			this.playerProperties.defaultDir = 'right';
		}
		else if(this.player1.y >= 540){
	...
	createExit(){
		...
		this.exitr2 = this.physics.add.staticImage(0, 300, 'borderv');
	...
	//enter other part of town
	enter4r2(){
		playerFinalXS4 = this.player1.x + 10;
		playerFinalYS4 = this.player1.y;
